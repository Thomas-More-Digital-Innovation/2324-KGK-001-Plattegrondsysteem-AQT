<div class="flex justify-center items-center flex-wrap h-screen pt-14">
    <?php
        foreach ($voedingsType as $type) {
            ?>
                <a href="./voedsel?id={{$type->id}}" class="w-72 hover:scale-105 transition duration-150 ease-out hover:ease-in my-5 mx-32 flex justify-center items-center flex-col">
