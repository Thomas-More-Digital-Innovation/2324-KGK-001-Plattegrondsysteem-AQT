...
<x-titlebar title="Admin: Dier" color="FF7E7E" back=true/>
    <div class="mb-8 pt-20">
        <h1 class="text-2xl font-bold text-center mt-10 mb-2">Aanpassen dier</h1>
                ...
                <div class="mt-10  grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-12 w-2/4">
                    ...
                    <div class="grid-cols-12 sm:grid-cols-12">
                        ...
                        <select id="dropdown" name="werkplek">
                            ...
                            @foreach($werkplek as $value)
                                <option value="{{ $value->id }}" @if($dierEdit->werkplekId == $value->id) selected @endif >{{ $value->name }} </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="grid-cols-12">
                        ...
                        <select id="dropdown" name="diersoort">
                            ...
                            @foreach($diersoort as $value)
                                <option value="{{ $value->id }}"  @if($dierEdit->diersoortId == $value->id) selected @endif >{{ $value->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="grid-cols-12">
                        ...
                        <select id="dropdown" name="quarantaine">
                            <option value="0" @if($dierEdit->quarantaine == 0) selected @endif>Nee</option>
                            <option value="1" @if($dierEdit->quarantaine == 1) selected @endif>Ja</option>
                        </select>
                    ...
                    <div class="grid-cols-12">
                        ...
                        <select id="dropdown" name="inventaris">
                            ...
                            @foreach($inventaris as $value)
                                <option value="{{ $value->id }}"  @if($dierEdit->inventarisid == $value->id) selected @endif>{{ $value->id }}</option>
                            @endforeach
                        </select>
